...
public class LoginSteps {
    ...
    public void user_enters_in_edit_filed_under_login_page(String value, String field) throws InterruptedException {
    	...
    	loginPage.insertPassword(field, value);
}
    ...
    public void user_clicks_on_the_button_under_login_page(String value)  {
    ...
    public void user_clicks_on_the_button_under_successful_user_login_page(String logout)  {
